...
sn_class = SN.SkyNetClassifier('unit_test_cla',n_jobs=4,activation=[3,3,3,0],max_iter=50,fix_seed=1,fixed_seed=0)
...
sn_reg = SN.SkyNetRegressor('unit_test_reg',n_jobs=4,activation=[3,3,3,0],layers=[10,10,10],max_iter=200,fix_seed=0,fixed_seed=0)
